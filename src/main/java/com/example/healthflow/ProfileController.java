package com.example.healthflow;//package com.example.healthflow;
//
...
//        return UserSession2.getInstance().getusername();
//    }
//
...
//                System.out.println("Error: No username found in session.");
//                return;
//            }
//
...
//                System.out.println("User ID: " + userId);  // Debugging info
...
//                    } else {
//                        System.out.println("No matching doctor or staff found for user ID: " + userId);
//                    }
//                }
//            } else {
//                System.out.println("User not found in 'user' table for username: " + loggedInUsername);
//            }
//
...
//    }
//
//    // Method to update username based on entered ID
////    public void handleUpdateUsername() {
////        String idString = txtfID.getText(); // Assuming txtfID is a TextField that holds the ID
////
...
public class ProfileController {
    ...
    void FAQPage(ActionEvent event) {
        try {
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Error", "Failed to load FAQ page.");
        }
    }
    ...
    private void initializeConnection() {
        try {
            String url = "jdbc:mysql://localhost:3306/healthflow"; // Update with your database URL
