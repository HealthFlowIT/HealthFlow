...
public class HomeController {
    ...
    public void updatePieChart(Statement statement, int totalPatients) throws Exception {
        ...
        // Customize the Y-axis numbering to show steps of 1
        NumberAxis yAxis = (NumberAxis) barGraph.getYAxis();
        yAxis.setTickUnit(1);  // Set Y-axis to increment by 1
        yAxis.setAutoRanging(false);  // Disable auto-ranging
        yAxis.setLowerBound(0);       // Set the lower bound
        yAxis.setUpperBound(10);      // Set an upper bound based on your data
